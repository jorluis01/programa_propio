...
$fecha2=$_GET['fecha2'];
   ...
   $costosventa=0;
   $compracredito=0;
   $compracreditoinicial=0;
   $compracreditofinal=0;
   $compradebito=0;
   $compradebitoinicial=0;
   $compradebitofinal=0;
   $cuentacobrar=0;
   $creditototal=0;
   $ventadebito=0;
...
?>
    ...
    <p style="text-align: center"><h1 style="text-align: center">COMPROBANTE DE PRUEBA <?php echo $fecha1; ?> & <?php echo $fecha2; ?> </h1> </p>
    <center><table style="width: 800px; height: 56px;" border="1">
      <tbody>
        <tr>
            
          <td style="width: 307.533px;"><center></center></td>
      <td style="width: 200.067px;"><center>INICIAL</center></td>
          <td style="width: 200.067px;"><center>ENTRADA</center></td>
          <td style="width: 200.067px;"><center>SALIDA</center></td>
          <td style="width: 200.067px;"><center>FINAL</center></td>
       ...
       $sql1="select sum(valortotal) as valortotal 
         ...
         $sql1="select sum(valortotal) as valortotal 
            from cuenta_pagar
            left join compra on (cuenta_pagar.idcompra=compra.idcompra)
            where compra.idcompra is not null and compra.fecha <='".$fecha1."'";
            $datos1=  mysqli_query($miconexion,$sql1);
            
             while($rs=mysqli_fetch_assoc($datos1)){
             $compracreditoinicial=$rs['valortotal'];
             
         }
         $compracreditofinal=$compracreditofinal+$compracredito;
         //primera parte compra credito 
...
AND fecha <='".$fecha1."'";
            ...
            $datos1=  mysqli_query($miconexion,$sql1);
             ...
             while($rs=mysqli_fetch_assoc($datos1)){
             $compradebitoinicial=$rs['valortotal'];
             
         }
         $compradebitofinal=$compradebitoinicial+$compradebito;
         //segunda parte compra debito
        ...
        echo "
          ...
          <td >$".number_format($compracreditoinicial, 0, '.', ',')."</td> 
          <td >$".number_format($compracredito, 0, '.', ',')."</td>"
                . "<td >$0 "; 
        
        
        echo "
          </td>
          <td >$".number_format($compracreditofinal, 0, '.', ',')." "; 
        ...
        echo "
          ...
          <td >$".number_format($compracreditoinicial, 0, '.', ',').   ""; 
        ...
        echo "
          ...
          <td >$".number_format($compradebitoinicial, 0, '.', ',')."</td>
        ...
        echo "
          ...
          <td >$0</td>
          <td >$".number_format($compradebitofinal, 0, '.', ',').""; 
        ...
        echo "
          ...
          <td >$".number_format($compradebitoinicial, 0, '.', ',')." "; 
        ...
        echo "
          ...
          <td >$".number_format($compradebito, 0, '.', ',')."</td>
          <td >$".number_format($compradebitofinal, 0, '.', ',')."</td>
