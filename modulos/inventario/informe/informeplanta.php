...
<div class="fechabalance">
    ...
    <p style=" text-align: center"><input name="buscarbalance" type="button" id="buscarcaja" value="Buscar" onclick="informecaja()" > 
</div>
<div class="tipobodega">
    <p style="text-align: center"><h1 style="text-align: center">INVENTARIO VALORIZADO PLANTA <?php echo $fecha; ?></h1> </p>
