...
?>
    ...
    <p style="text-align: center"><h1 style="text-align: center">COMPRABANTE DE CONTABILIDAD <?php echo $fecha1; ?> & <?php echo $fecha2; ?> </h1> </p>
...
AND fecha >='".$fecha1."'AND fecha <='".$fecha2."'";
         ...
         $sql2="select * 
            from movimientoaja
            where   tipomovimiento < 3 and fecha >='".$fecha1."'AND fecha <='".$fecha2."' ";
         ...
         $sql2="select * 
            from movimientoaja
            where   tipomovimiento > 2 and fecha >='".$fecha1."'AND fecha <='".$fecha2."' ";
